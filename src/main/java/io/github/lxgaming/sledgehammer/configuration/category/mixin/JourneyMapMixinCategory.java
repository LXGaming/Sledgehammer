...
public class JourneyMapMixinCategory {
    ...
    @Mapping(value = "journeymap.client.task.multi.TaskControllerMixin", dependencies = {"journeymap"})
    @Mapping(value = "journeymap.client.JourneymapClientMixin", dependencies = {"journeymap"})
